...
//        pTGraph->GetYaxis()->SetRangeUser(0,525);
    ...
    std::string resultsName =  "True_vs_True_Jets_Detector_Model_" + IntToString(detectorModel) + "_TimingCutScan_HadEnergyTrunc_1000000GeV.pdf";
    pTCanvas->SaveAs(resultsName.c_str());
    std::string resultsName2 =  "RecoMinusTrue_vs_True_Jets_Detector_Model_" + IntToString(detectorModel) + "_TimingCutScan_HadEnergyTrunc_1000000GeV.pdf";
