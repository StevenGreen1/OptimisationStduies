...
/*
    ...
    std::string resultsName1 =  "Reco_vs_True_Kaon0L_Detector_Model_" + IntToString(detectorModel) + "_TimingCutScan_HadEnergyTrunc_1000000GeV.pdf";
    std::string resultsName1a = "Reco_vs_True_Kaon0L_Detector_Model_" + IntToString(detectorModel) + "_TimingCutScan_HadEnergyTrunc_1000000GeV.C";
    std::string resultsName2 =  "EnergyResolution_vs_True_Kaon0L_Detector_Model_" + IntToString(detectorModel) + "_TimingCutScan_HadEnergyTrunc_1000000GeV.pdf";
    std::string resultsName2a = "EnergyResolution_vs_True_Kaon0L_Detector_Model_" + IntToString(detectorModel) + "_TimingCutScan_HadEnergyTrunc_1000000GeV.C";
    std::string resultsName3 =  "RecoMinusTrue_vs_True_Kaon0L_Detector_Model_" + IntToString(detectorModel) + "_TimingCutScan_HadEnergyTrunc_1000000GeV.pdf";
    std::string resultsName3a = "RecoMinusTrue_vs_True_Kaon0L_Detector_Model_" + IntToString(detectorModel) + "_TimingCutScan_HadEnergyTrunc_1000000GeV.C";
    std::string resultsName4 =  "ScaledEnergyResolution_vs_True_Kaon0L_Detector_Model_" + IntToString(detectorModel) + "_TimingCutScan_HadEnergyTrunc_1000000GeV.pdf";
    std::string resultsName4a = "ScaledEnergyResolution_vs_True_Kaon0L_Detector_Model_" + IntToString(detectorModel) + "_TimingCutScan_HadEnergyTrunc_1000000GeV.C";
...
//    pTH1F->GetFunction(fitFunctionName.c_str())->Delete();
    ...
    {
        std::string resultsName1 = IntToString(energy) + "GeV_Detector_Model_38_TimingCutScan_HadEnergyTrunc_1000000GeV.C";
        std::string resultsName2 = IntToString(energy) + "GeV_Detector_Model_38_TimingCutScan_HadEnergyTrunc_1000000GeV.pdf";
