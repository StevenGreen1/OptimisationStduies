...
void MakePlots2(int detectorModel, int energy)
{
...
/*
    ...
    std::string resultsName1 =  "Reco_vs_True_Kaon0L_Detector_Model_" + IntToString(detectorModel) + "_TimingCutScan_HadEnergyTrunc_1GeV.pdf";
    std::string resultsName1a = "Reco_vs_True_Kaon0L_Detector_Model_" + IntToString(detectorModel) + "_TimingCutScan_HadEnergyTrunc_1GeV.C";
    std::string resultsName2 =  "EnergyResolution_vs_True_Kaon0L_Detector_Model_" + IntToString(detectorModel) + "_TimingCutScan_HadEnergyTrunc_1GeV.pdf";
    std::string resultsName2a = "EnergyResolution_vs_True_Kaon0L_Detector_Model_" + IntToString(detectorModel) + "_TimingCutScan_HadEnergyTrunc_1GeV.C";
    std::string resultsName3 =  "RecoMinusTrue_vs_True_Kaon0L_Detector_Model_" + IntToString(detectorModel) + "_TimingCutScan_HadEnergyTrunc_1GeV.pdf";
    std::string resultsName3a = "RecoMinusTrue_vs_True_Kaon0L_Detector_Model_" + IntToString(detectorModel) + "_TimingCutScan_HadEnergyTrunc_1GeV.C";
    std::string resultsName4 =  "ScaledEnergyResolution_vs_True_Kaon0L_Detector_Model_" + IntToString(detectorModel) + "_TimingCutScan_HadEnergyTrunc_1GeV.pdf";
    std::string resultsName4a = "ScaledEnergyResolution_vs_True_Kaon0L_Detector_Model_" + IntToString(detectorModel) + "_TimingCutScan_HadEnergyTrunc_1GeV.C";
...
void plot(int energy, TCanvas *pTCanvas, TFile *pTFile, TLegend *pTLegend, int colour, int style, int recoVar)
{
    ...
    pTH1F->GetYaxis()->SetRangeUser(0.1,maxNumberEntriesHist);
...
//    pTH1F->GetFunction(fitFunctionName.c_str())->Delete();
    ...
    if (recoVar == 43 or recoVar == 38)
    {
        std::string resultsName1 = IntToString(energy) + "GeV_Detector_Model_38_TimingCutScan_HadEnergyTrunc_1GeV.C";
        std::string resultsName2 = IntToString(energy) + "GeV_Detector_Model_38_TimingCutScan_HadEnergyTrunc_1GeV.pdf";
...
{
    if (a == 38)
        return "#splitline{Timing Cut in ECal and HCal 10^{6} ns,}{Hadronic Energy Truncation 1 GeV}";
    else if (a == 43)
        return "#splitline{Timing Cut in ECal and HCal 10^{6} ns,}{Hadronic Energy Truncation 10^{6} GeV}";
    else if (a == 46)
        return "#splitline{Timing Cut in ECal and HCal 10 ns,}{Hadronic Energy Truncation 1 GeV}";
    else if (a == 51)
        return "#splitline{Timing Cut in ECal and HCal 10 ns,}{Hadronic Energy Truncation 10^{6} GeV}";
    else if (a == 54)
        return "#splitline{Timing Cut in ECal and HCal 300 ns,}{Hadronic Energy Truncation 1 GeV}";
    else if (a == 59)
        return "#splitline{Timing Cut in ECal and HCal 300 ns,}{Hadronic Energy Truncation 10^{6} GeV}";
    else if (a == 71)
...
//    else if (a==51)
//        colour = 10001;  // Orange
    else if (a==71 or a==76) 
        colour = 10004; // Gold <==
//    else if (a==76)
//        colour = 8; // Green
    else if (a==54 or a==59)
        colour = 10003; // Light Blue <==
//    else if (a==59)
//        colour = 4; // Blue
//    else if (a==38 or a==43)
//        colour = 10002; // Violet
    else if (a==43 or a ==38)
        colour = 1; // Black
    return colour;
}
