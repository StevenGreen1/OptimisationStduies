...
void Draw_ER_vs_SiECalCellSize() 
{
    ...
    const std::string name("ER_vs_SiECalCellSize_" + NumberToString(energy) + "GeVPhoton.C");
    const std::string name2("ER_vs_SiECalCellSize_" + NumberToString(energy) + "GeVPhoton.pdf");
