...
//=========  (Tue Feb 21 16:26:00 2017) by ROOT version5.34/30
   ...
   TH2F *axesEj = new TH2F("axesEj","100 GeV Photon Energy Resolution vs Number of Layers in ECal (Si)",100,14,32,1000,2,3.4);
   axesEj->SetStats(0);
   ...
   gre->SetPoint(0,30,2.242834);
   gre->SetPointError(0,0,0.05860003);
