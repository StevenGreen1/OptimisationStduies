...
//=========  (Thu Jan 12 16:08:13 2017) by ROOT version5.34/30
   ...
   TH2F *axesEj = new TH2F("axesEj","10 GeV Photon Energy Resolution vs Cell Size in ECal (Sc)",100,0,25,1000,0,8.5);
   axesEj->SetStats(0);
