...
void DrawNumLayersScECal10GeV() 
{
    ...
    TH2F *pAxes = new TH2F("axesEj","",100,14,32,1000,5.4,8.2);
    pAxes->SetTitle("10 GeV Photon Energy Resolution vs Number of Layers in ECal (Sc)");
