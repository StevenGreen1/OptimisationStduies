...
void Draw_ER_vs_SiECalNLayers() 
{
    ...
    const std::string name("ER_vs_SiECalNLayers_" + NumberToString(energy) + "GeVPhoton.C");
    const std::string name2("ER_vs_SiECalNLayers_" + NumberToString(energy) + "GeVPhoton.pdf");
