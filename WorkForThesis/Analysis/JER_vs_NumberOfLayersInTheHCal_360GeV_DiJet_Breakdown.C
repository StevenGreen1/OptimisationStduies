{
    ...
    float Pandora_Settings_Default_JER[8] = {3.38347,3.07476,2.96963,2.93226,2.87282,2.8942,2.92408,2.88876};

    float Pandora_Settings_PerfectPFA_JER[8] = {1.99352,1.86839,1.86131,1.79188,1.82326,1.76751,1.74387,1.72612};

    float Pandora_Settings_TotalConfusion_JER[8] = {2.73381551142,2.44198031636,2.31392035749,2.32105897667,2.22009408017,2.29179013871,2.34716025646,2.31634282506};

    float Pandora_Settings_PhotonConfusion_JER[8] = {1.11994666538,0.93268089157,0.999256626348,0.90616427578,0.83987053544,0.96571685866,1.05367161716,0.962662707286};

    float Pandora_Settings_NeutralHadronConfusion_JER[8] = {1.87631637503,1.76022766028,1.66824360391,1.67154866827,1.7232184231,1.71329556671,1.68377262167,1.74617055066};

    float Pandora_Settings_OtherConfusion_JER[8] = {1.64283400805,1.41243506187,1.25406415047,1.33120476565,1.11980064065,1.17656758833,1.25053874438,1.17881847763};

    float Pandora_Settings_Default_JERError[8] = {0.0430955,0.0391634,0.0378243,0.0373483,0.0365912,0.0368636,0.0372442,0.0367943};

    float Pandora_Settings_PerfectPFA_JERError[8] = {0.0253915,0.0237978,0.0237075,0.0228232,0.023223,0.0225129,0.0222118,0.0219857};

    float Pandora_Settings_TotalConfusion_JERError[8] = {0.0500195834651,0.0458269214315,0.0446400006657,0.0437698165125,0.0433384065969,0.043194378603,0.0433646586329,0.0428624628451};

    float Pandora_Settings_PhotonConfusion_JERError[8] = {0.0592536673728,0.0540962618398,0.0519555487313,0.0515416857305,0.0506298094406,0.0506611530668,0.0509333580848,0.0505694880832};

    float Pandora_Settings_NeutralHadronConfusion_JERError[8] = {0.0523097974335,0.0477769452752,0.0456713279366,0.045498109129,0.0443533294032,0.0440345701461,0.0442048789971,0.0437297961672};

    float Pandora_Settings_OtherConfusion_JERError[8] = {0.0415610052982,0.0381617243155,0.0371381917479,0.0364596294411,0.0358055190112,0.0351883603399,0.035219562874,0.0345279528007};
