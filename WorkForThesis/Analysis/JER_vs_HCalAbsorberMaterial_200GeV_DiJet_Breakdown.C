{
    ...
    float Pandora_Settings_Default_JER[4] = {2.85823,2.91541,3.12068,3.02638};

    float Pandora_Settings_PerfectPFA_JER[4] = {2.03499,2.11394,2.07323,2.06823};

    float Pandora_Settings_TotalConfusion_JER[4] = {2.00706114326,2.00770345034,2.33245815171,2.20938918516};

    float Pandora_Settings_PhotonConfusion_JER[4] = {0.715096779464,0.794091075192,0.874108508596,0.458021826991};

    float Pandora_Settings_NeutralHadronConfusion_JER[4] = {1.50065946064,1.4634631256,1.51094019246,1.60202838627};

    float Pandora_Settings_OtherConfusion_JER[4] = {1.12470094336,1.12185925534,1.54704721308,1.45090372772};

    float Pandora_Settings_Default_JERError[4] = {0.0366349,0.0373679,0.0421138,0.0387902};

    float Pandora_Settings_PerfectPFA_JERError[4] = {0.0260831,0.0270951,0.0279783,0.0265092};

    float Pandora_Settings_TotalConfusion_JERError[4] = {0.0449716553688,0.0461574606796,0.0505605198004,0.0469832096568};

    float Pandora_Settings_PhotonConfusion_JERError[4] = {0.0509913804206,0.0518571267635,0.0583788132022,0.0545422031299};

    float Pandora_Settings_NeutralHadronConfusion_JERError[4] = {0.0463277603803,0.0472618173753,0.0534142107062,0.0501875934243};

    float Pandora_Settings_OtherConfusion_JERError[4] = {0.0396043310384,0.040927345162,0.0447374114807,0.0418488865216};
