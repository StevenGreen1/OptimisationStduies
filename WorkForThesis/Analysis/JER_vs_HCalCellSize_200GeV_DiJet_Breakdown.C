{
    ...
    float Pandora_Settings_Default_JER[6] = {2.79637,2.83941,2.90164,2.9959,3.016,3.30898};

    float Pandora_Settings_PerfectPFA_JER[6] = {2.06792,2.07743,2.08207,2.11565,2.11659,2.19115};

    float Pandora_Settings_TotalConfusion_JER[6] = {1.88238998364,1.93559648253,2.02101439992,2.1211887911,2.14855830079,2.47955849253};

    float Pandora_Settings_PhotonConfusion_JER[6] = {0.749196127393,0.700243689011,0.6780299208,0.74484861623,0.824439641878,0.727618856476};

    float Pandora_Settings_NeutralHadronConfusion_JER[6] = {1.30940128608,1.38300221836,1.44011317253,1.56669014017,1.59481828883,1.85505657102};

    float Pandora_Settings_OtherConfusion_JER[6] = {1.12586210754,1.15909334534,1.24533075185,1.22070652947,1.1803205812,1.47565112269};

    float Pandora_Settings_Default_JERError[6] = {0.0358421,0.0363937,0.0371913,0.0383995,0.0386571,0.0424124};

    float Pandora_Settings_PerfectPFA_JERError[6] = {0.0265053,0.0267615,0.0266867,0.0272381,0.0271291,0.0280848};

    float Pandora_Settings_TotalConfusion_JERError[6] = {0.0445778621256,0.0450026973228,0.0457751148841,0.0469394096037,0.0472266311105,0.050868106922};

    float Pandora_Settings_PhotonConfusion_JERError[6] = {0.0497711962843,0.0506800537848,0.0518720921265,0.0534600728183,0.0536381666387,0.0592510045509};

    float Pandora_Settings_NeutralHadronConfusion_JERError[6] = {0.0458605829755,0.0466225599461,0.0476933076897,0.0486158719781,0.0484517416519,0.0534633774771};

    float Pandora_Settings_OtherConfusion_JERError[6] = {0.0401659044333,0.0401955037051,0.0409770163,0.0411787721717,0.0412412561633,0.0439911714514};
