{
    ...
    float Pandora_Settings_Default_JER[4] = {2.87901,2.86234,3.35563,3.38325};

    float Pandora_Settings_PerfectPFA_JER[4] = {1.74233,1.71837,1.86062,1.86124};

    float Pandora_Settings_TotalConfusion_JER[4] = {2.29193908104,2.28914718153,2.79255186389,2.82527277};

    float Pandora_Settings_PhotonConfusion_JER[4] = {0.920408090849,0.886746392832,1.03606538138,0.955805773994};

    float Pandora_Settings_NeutralHadronConfusion_JER[4] = {1.74437332309,1.72553070836,1.91449322524,2.01655038987};

    float Pandora_Settings_OtherConfusion_JER[4] = {1.16747394284,1.21508000889,1.74917984453,1.7326644431};

    float Pandora_Settings_Default_JERError[4] = {0.0366701,0.0364577,0.0427408,0.0430926};

    float Pandora_Settings_PerfectPFA_JERError[4] = {0.0221922,0.021887,0.0236988,0.0237067};

    float Pandora_Settings_TotalConfusion_JERError[4] = {0.0428624114641,0.0425229285753,0.0488713490751,0.0491831206667};

    float Pandora_Settings_PhotonConfusion_JERError[4] = {0.0371315458572,0.0503064951629,0.0589862478999,0.0597136194875};

    float Pandora_Settings_NeutralHadronConfusion_JERError[4] = {0.0474078073269,0.0438196245499,0.0520639084041,0.0525149343743};

    float Pandora_Settings_OtherConfusion_JERError[4] = {0.0347290807966,0.0346063047626,0.0402445893371,0.0401379163963};
