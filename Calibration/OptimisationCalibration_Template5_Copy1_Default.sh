...
do
    ...
    do
        calibrationResultsPath="/r04/lc/sg568/HCAL_Optimisation_Studies/CalibrationResults/Detector_Model_${detModel}/Reco_Stage_${recoStage}/DefaultCalibration/"
        calibrationFilePath="/r04/lc/sg568/HCAL_Optimisation_Studies/Calibration/Detector_Model_${detModel}/Reco_Stage_${recoStage}/DefaultCalibration/"
        currentMHHHE="${MHHHE[${recoStage}]}"
        cd MyCalibration_Template5_Copy1
