...
for detectorModel in [38]:
    for recoStage in [71]:
        outputPath = '/var/clus/usera/sg568/ilcsoft_v01_17_07/OptimisationStudiesScECal/Calibration/MyCalibration_Development/TestCalibration'
        ...
        Calibration(detectorModel, recoStage, slcioFormat, slcioPath, gearFile, pandoraSettings, outputPath, timingCut, hadronicEnergyTrunc, 'Si', True) # Last option is realistic digitisation
