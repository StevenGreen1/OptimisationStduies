...
### ----------------------------------------------------------------------------------------------------
    ...
    def __init__(self, detModelNumber, recoVariant, slcioFormat, slcioPath, gearFile, pandoraSettings, outputPath, timingCut, hadronicEnergyTrunc):
...
<processor name="MyILDCaloDigi" type="ILDCaloDigi">
  ...
  <parameter name="CalibrECAL" type="FloatVec">""" + str(self._CalibrECal) + """</parameter>
