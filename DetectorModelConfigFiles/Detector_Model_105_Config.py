...
HCalNLayersLowGran           = 25                  # At and after layer HCalNLayersLogGran the HCal cell size is HCalCellSizeLogGran times the normal size
HCalCellSizeLowGran          = 2.0                 # At and after layer HCalNLayersLogGran the HCal cell size is HCalCellSizeLogGran times the normal size
