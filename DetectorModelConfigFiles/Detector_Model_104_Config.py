...
HCalNLayersLowGran           = 24                  # After layer HCalNLayersLogGran the HCal cell size is HCalCellSizeLogGran times the normal size
HCalCellSizeLowGran          = 2.0                 # After layer HCalNLayersLogGran the HCal cell size is HCalCellSizeLogGran times the normal size
